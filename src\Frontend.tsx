          ...
          {step === 2 && member ? (
            <>
              ...
              <div className="member-summary-grid mt-3 grid grid-cols-2 gap-2">
                ...
                <div className="member-summary-item rounded-md border border-sage-100 bg-sage-50/60 px-2.5 py-2.5 flex items-center gap-1.5 min-w-0 overflow-visible">
                      ...
                      return (
                        <div className="grid grid-cols-1 xl:grid-cols-12 gap-8 items-start">
                          ...
                          <div className="xl:col-span-7 space-y-6">
                            ...
                            <section className="fitness-booking-section bg-white border border-sage-100 p-4 sm:p-5 rounded-2xl shadow-sm">
